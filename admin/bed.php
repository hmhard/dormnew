...
<?php
			$q1="SELECT *FROM block where blocktype='mblock'";
...
<a href="assignfemale.php" class="btn btn-default btn-lg" style="text-align:center" >Assign Female</a>
</div>
</tr>
